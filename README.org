...
- Send a [[mailto:~bzg/orgology@lists.sr.ht?subject=\[BUG\] hop: <SHORT EXPLICIT BUG DESCRIPTION>][bug report]]
- Send a [[mailto:~bzg/orgology@lists.sr.ht?subject=\[PATCH\] hop: <COMMIT SUMMARY>][patch]] (please use =git format-patch=)
- Send a [[mailto:~bzg/orgology@lists.sr.ht?subject=\[FR\] hop: <FEATURE REQUEST>][feature request]]
- Share any [[mailto:~bzg/orgology@lists.sr.ht?subject=hop: <ANYTHING>][other question or idea]]
